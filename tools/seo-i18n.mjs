...
/**
 * Long-tail SEO pages that exist as independent static HTML (not generated by
 * the i18n builder). Each entry has the canonical FR + EN URL — the sitemap
 * adds them as standalone urlset entries with cross-language alternates.
 *
 * Add new bonus pages here; the builder will append them to sitemap.xml.
 */
